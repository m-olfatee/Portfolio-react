...
const Footer = () => {
    return (
        <footer>
            <h3>You can also reach me through:</h3>
            <div className="add">
                <a href="https://www.linkedin.com/" target="_blank" rel="noreferrer">
                    <svg aria-hidden="true" id="linkedin" focusable="false" data-prefix="fab" data-icon="linkedin-in"
                ...
                <a href="https://www.xing.com/" target="_blank" rel="noreferrer">
                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="xing"
                        className="svg-inline--fa fa-xing fa-w-12" role="img" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 384 512">
                        <path fill="#fff"
                ...
                <a href="https://www.behance.net/" target="_blank" rel="noreferrer">
                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="behance"
                        className="svg-inline--fa fa-behance fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512">
                        <path fill="#fff"
